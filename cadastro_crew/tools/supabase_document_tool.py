...
def _run_supabase_query(document_name: str, case_id: str) -> str:
    """Función auxiliar para ejecutar la consulta a Supabase."""
...
if BASETOOL_AVAILABLE:
    ...
    class SupabaseDocumentContentTool(BaseTool):
        ...
        def _run(self, document_name: str, case_id: str) -> str:
            return _run_supabase_query(document_name, case_id)
    ...
    def SupabaseDocumentContentTool(document_name: str, case_id: str) -> str:
...
# Ejemplo de uso (para teste local, se necessário):
